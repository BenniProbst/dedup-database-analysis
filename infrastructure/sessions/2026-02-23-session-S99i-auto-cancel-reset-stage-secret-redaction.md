...
6. **Pipeline #6929** — Alle 7 Builds SUCCESS, Aggregate/Experiment-Pipeline laeuft
...
| (pending) | fix: CI workflow:rules nur development + RBAC docs | Noch nicht gepusht |
...
1. ~~Pipelines canceln~~ **ERLEDIGT** — alle alten Pipelines canceled
2. **Pipeline #6929 (development, e5c74a7) ist die AKTIVE Pipeline** — 7/7 Builds SUCCESS, Aggregate + Experiment laeuft
...
9. **ALLE Remotes KONSISTENT** — GitLab + GitHub auf `e5c74a7` (development + master)
10. **workflow:rules Commit NOCH NICHT GEPUSHT** — muss committed + gepusht werden
...
### Pipeline-Status (aktuell)

| Pipeline | Status | Branch | Commit | Aktion |
|----------|--------|--------|--------|--------|
| #6929 | **running** | development | e5c74a7 | AKTIV — 7/7 Builds SUCCESS, Experiment laeuft |
| #6930 | canceled | master | e5c74a7 | CI-Rules schliessen master aus |
| #6928 | canceled | development | 3d3b557 | Alt (Session-Dok mit Tokens) |
| #6927 | canceled | master | e30b383 | Alt |
| #6926 | canceled | development | e30b383 | Alt (vor Session-Dok Push) |
| #6921-6925 | canceled | diverse | diverse | Alt (pre-redaction) |
