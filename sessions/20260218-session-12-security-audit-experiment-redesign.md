...
1. Security-Cleanup (Task #58): `[CLUSTER-PW-REDACTED]` aus allen Dateien entfernen
2. config.hpp Redesign (Task #59): Neue Enums fuer doku.tex Experiment-Spec
3. Pipeline 1310 Ergebnisse pruefen (smoke-test + dry-test)
...
curl -sk --header "PRIVATE-TOKEN: glpat-..." \
  "https://gitlab.comdare.de/api/v4/projects/280/pipelines/1310/jobs"
...
| Neues Passwort | Cluster/keys/database-credentials.md (zu aktualisieren) |
| C++ Source | `src/cpp/` (32 Dateien, ~3.500 LOC) |
| doku.tex (Spec) | `docs/20260218 doku.tex` |
