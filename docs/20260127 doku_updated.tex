...
\begin{itemize}
    ...
    \item \textbf{Redcomponent-DB} (very recent / experimental system; treated as a black box in measurement and compared empirically).
\end{itemize}

To broaden the design space beyond the new Redcomponent-DB, two additional, widely used database architectures are included:
\begin{itemize}
